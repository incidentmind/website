---
name: visionary-press-release
description: Generate a press release using the Amazon Working Backwards style to clarify customer value before building, with a stable structure PMs can reuse for alignment.
---
